...
It's also part of the NTP Pool project, with public status pages for [IPv4][3] and [IPv6][4].
...
Time server uses multiple sources simultaneously. GPS is used with L1C/A and L5 frequencies. Galileo is used with E1 and E5a. BeiDou is used with B1C and B2a frequencies.
...
* The NEO-F10T is connected to Raspberry Pi 4 Model B 2GB RAM using UART (115200/8/1/n) directly.
