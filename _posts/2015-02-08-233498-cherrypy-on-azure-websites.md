...
layout: post
---
Let me state that upfront: I'm a Python newbie. I started playing with as a way to expand my view. Lately I was looking for something new to try among simple scripts that do this or that. I thought something web based is a good way to start. Web is now everywhere and it's easier that packing up some application (IMO).
