...
[![Kreuzspitze 1]({% include post_i_link post=page name="001_thumb.jpg" %})]({% include post_i_link post=page name="001.jpg" %})

[![Kreuzspitze 2]({% include post_i_link post=page name="002_thumb.jpg" %})]({% include post_i_link post=page name="002.jpg" %})
