...
[![image]({% include post_i_link post=page name="nuodb_console_thumb.jpg" %})][1]
...
[![image]({% include post_i_link post=page name="nuodb_flights1_thumb.jpg" %})][2]

[![image]({% include post_i_link post=page name="nuodb_flights2_thumb.jpg" %})][3]
