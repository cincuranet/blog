...
[![image]({% include post_ilink post=page name="nuodb_console_thumb.jpg" %})][1]
...
[![image]({% include post_ilink post=page name="nuodb_flights1_thumb.jpg" %})][2]

[![image]({% include post_ilink post=page name="nuodb_flights2_thumb.jpg" %})][3]
