...
![image]({{ site.url }}/i/230963/associations_no_fk_1.png)
...
![image]({{ site.url }}/i/230963/associations_no_fk_2.png)
...
[2]: {{ site.url }}{% post_url 2009-10-03-230843-prednaska-ado-net-entity-framework-microsoft-praha %}