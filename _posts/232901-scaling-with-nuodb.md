...
[![image]({% include post_ilink, post: page, name: "nuodb_console_thumb.jpg" %})]({% include post_ilink, post: page, name: "nuodb_console.png" %})
...
[![image]({% include post_ilink, post: page, name: "nuodb_flights1_thumb.jpg" %})]({% include post_ilink, post: page, name: "nuodb_flights1.png" %})

[![image]({% include post_ilink, post: page, name: "nuodb_flights2_thumb.jpg" %})]({% include post_ilink, post: page, name: "nuodb_flights2.png" %})
